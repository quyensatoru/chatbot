const EMOJI_RE = /[\u{1F600}-\u{1F64F}\u{1F300}-\u{1F5FF}\u{1F680}-\u{1F6FF}\u{1F1E0}-\u{1F1FF}\u{2702}-\u{27B0}\u{24C2}-\u{1F251}]+/gu;
const QUESTION_RE = /\?/;
const DAYS = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];

const STOPWORDS = new Set([
	"và", "của", "là", "có", "không", "được", "cho", "với", "các", "một", "trong", "này", "đã",
	"từ", "bạn", "tôi", "thì", "mình", "nha", "nhé", "the", "a", "an", "is", "are", "was", "were",
	"be", "been", "to", "of", "in", "it", "i", "you", "we", "he", "she", "they", "that", "this",
	"for", "on", "at", "by", "or", "and", "but", "not", "with", "my", "ok", "okay", "yes", "no",
	"hi", "hello", "ạ", "ơi", "thôi", "rồi", "vậy", "ừ", "oke", "ok", "lol",
]);
...
export function computeStats(messages) {
	...
	const channelsActive = Object.entries(chDist).sort((a, b) => b[1] - a[1]).map(([ch]) => ch);
